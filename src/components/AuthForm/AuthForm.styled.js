...
export const SWrapper = styled.div`
  ...
  overflow-x: hidden;
  overflow-y: scroll;
  background-color: ${({ themeMode }) => (themeMode === "light" ? "#eaeef6" : "#151419")};
`;
...
export const SModalBlock = styled.div`
  display: block;
  margin: 0 auto;
  background-color: ${({ themeMode }) => (themeMode === "light" ? "#ffffff" : "#20202C")};
  max-width: 368px;
  width: 100%;
  padding: 50px 60px;
  border-radius: 10px;
  border: 0.7px solid ${({ themeMode }) => (themeMode === "light" ? "#d4dbe5" : "#20202C")};
...
//   box-shadow: 0px 4px 67px -12px
//     ${({ themeMode }) =>
//       themeMode === "light" ? "rgba(0, 0, 0, 0.13)" : "rgba(0,0,0,0.5)"};
// `;
...
//     color: rgba(148, 166, 190, 0.4);
//     /* color: ${({ themeMode }) =>
//       themeMode === "light" ? "#94A6BE66" : "#94A6BE66"}; */
//     font-size: 14px;
//     font-weight: 400;
//     line-height: 150%;
//     letter-spacing: -0.14px;
